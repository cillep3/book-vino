...
const CreateWinery = () => {
  ...
  return (
    <div id="createContainerDesk">
      <h1 id="createHeadlineDesk">Create winery</h1>

      <form id="createFormDesk" onSubmit={handleSubmit}>
      ...
      {winery && (
        <div>
          ...
          <div>
            ...
            <img
              className="pictures"
              src={"http://localhost:5001/images/" + winery.created.pictures}
              width="200px"
            />
          </div>
        </div>
