  ...
  return (
    <div className="singlewineDesk">
      ...
      <div className="sectionTwoDesk">
        ...
        <p>
          Wine is often served with dinner. It may be the oldest known type of
          wine, as it is the most straightforward to make with the skin contact
          method. In the unreliable summers of northern France, the acidity of
          under ripened grapes was often masked with chaptalization with
          unsatisfactory results, whereas now the less ripe grapes are made into
      ...
      <div className="sectionTreeDesk">
        ...
        <p>
          <FaMapMarkerAlt />
          Via Valesana 35, 37017, Lazise, Italy
        </p>
        <br></br>
        <p>
          <FaMobileAlt /> +39 045 7580731 / +39 340 9067014
        </p>
        <br></br>
        <p>
          <FaRegEnvelope /> info@marcellomarchesini.it
        </p>
        <br></br>
        <p>
          <FaGlobe /> info@marcellomarchesini.it
        </p>
        <br></br>
        <p>
          <BsClock /> Monday to Saturday 9 am - 22 am
        </p>
      </div>
