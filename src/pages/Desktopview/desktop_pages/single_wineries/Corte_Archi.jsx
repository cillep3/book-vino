  ...
  return (
    <div className="singlewineDesk">
      ...
      <div className="sectionTwoDesk">
        ...
        <p>
          Fernando and Silvia will welcome you cordially to show the cellar and,
          in the tasting room or on the portico surrounded by the Arches, they
          will accompany you through the tasting journey in the wonderful world
          of their wines.
        </p>
      </div>
      ...
      <div className="sectionTreeDesk">
        ...
        <p>
          <FaMapMarkerAlt />
          Corte Archi, Via Paverno 21, 37020, Valgatara - Marano di
          Valpolicella, Italy, Via Paverno 21
        </p>
        <br></br>
        <p>
          <FaMobileAlt /> +39 3358140026 / +39 45 7701237
        </p>
        <br></br>
        <p>
          <FaRegEnvelope /> info@cortearchi.it / info@cortearchi.it
        </p>
        <br></br>
        <p>
          <FaGlobe /> http://www.cortearchi.it
        </p>
        <br></br>
        <p>
          <BsClock /> Monday to Saturday 10 am - 6pm
        </p>
      </div>
