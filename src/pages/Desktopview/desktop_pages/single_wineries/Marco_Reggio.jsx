...
const Marco_Reggio = (props) => {
  ...
  return (
    <div className="singlewineDesk">
      ...
      <Slider sliderdata={Register.reggio_desk} className="topimg" />
      ...
      <div className="sectionTwoDesk">
        ...
        <p>
          At this idyllic family-owned place, you instantly sense enthusiasm
          from the wine farmer, which gives you great quality for your money.
          Absolutely top notch with wine that is to pay off and that will
          impress at any dinner party. Of all the places we’ve visited in
          Valpolicella, this is where you get the best value for money. Even
          local wine growers recommend this place, which has helped us to find
          it – look forward to this experience.
        </p>
      </div>
      ...
      <div className="sectionTreeDesk">
        ...
        <p>
          <FaMapMarkerAlt />
          Via Marognole, 7, 37020 Marano di Valpolicella VR, Italy.
        </p>
        <br></br>
        <p>
          <FaMobileAlt /> +39 3479698516
        </p>
        <br></br>
        <p>
          <FaRegEnvelope /> marcoreg@libero.it
        </p>
        <br></br>
        <p>
          <FaGlobe /> http://www.marcoreg.libero.it
        </p>
        <br></br>
        <p>
          <BsClock /> Monday to Saturday 8.30 am - 7pm
        </p>
      </div>
