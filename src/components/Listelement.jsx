      ...
      <figure>
        {
          <div id="listElement">
            <img
              id="hero"
              src={Register.winery[0].image}
              alt="Marchesini Marcello"
            />
            <div id="borderBox">
              <h1>{Register.winery[0].title}</h1>
              <img
                id="stars"
                src={Register.winery[0].stars}
                alt="Marchesini Marcello"
              />
            </div>
            <div id="icons">
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[0].icons[0].vector}
                  alt="Food"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[0].icons[1].vector}
                  alt="Tasting"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[0].icons[2].vector}
                  alt="Tour"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[0].icons[3].vector}
                  alt="Country"
                />
          ...
          <div id="listElement">
            ...
            <div id="icons">
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[1].icons[0].vector}
                  alt="Food"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[1].icons[1].vector}
                  alt="Tasting"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[1].icons[2].vector}
                  alt="Tour"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[1].icons[3].vector}
                  alt="Country"
                />
          ...
          <div id="listElement">
            ...
            <div id="icons">
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[2].icons[0].vector}
                  alt="Food"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[2].icons[1].vector}
                  alt="Tasting"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[2].icons[2].vector}
                  alt="Tour"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[2].icons[3].vector}
                  alt="Country"
                />
          ...
          <div id="listElement">
            ...
            <div id="icons">
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[3].icons[0].vector}
                  alt="Food"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[3].icons[1].vector}
                  alt="Tasting"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[3].icons[2].vector}
                  alt="Tour"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[3].icons[3].vector}
                  alt="Country"
                />
          ...
          <div id="listElement">
            ...
            <div id="icons">
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[4].icons[0].vector}
                  alt="Food"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[4].icons[1].vector}
                  alt="Tasting"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[4].icons[2].vector}
                  alt="Tour"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[4].icons[3].vector}
                  alt="Country"
                />
          ...
          <div id="listElement">
            ...
            <div id="icons">
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[5].icons[0].vector}
                  alt="Food"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[5].icons[1].vector}
                  alt="Tasting"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[5].icons[2].vector}
                  alt="Tour"
                />
              ...
              <div id="icons_border">
                <img
                  id="icon_image"
                  src={Register.winery[5].icons[3].vector}
                  alt="Country"
                />
